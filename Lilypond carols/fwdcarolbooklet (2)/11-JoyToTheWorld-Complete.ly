\header {
	filename = "JoyToTheWorld-Complete.ly"
	enteredby = "Gordon Gilbert"
	composer = "from G.F.Handel, arr Lowell Mason, 1830"
...
sop = \context Voice = "sop"    {
	\voiceOne
	d''4 cis''8. b'16 a'4. g'8 fis'4 e' d'4. \bar "||"
	a'8 \bar "|"b'4. b'8 cis''4. cis''8 d''4. \bar "||"
	d''8 \bar "|" d''( cis'') b'( a') a'8.( g'16 fis'8) 
	d'' d''( cis'') b'( a') a'8.( g'16 fis'8) \bar "||"
	fis' \bar "|" fis' fis' fis' fis'16( g') a'4.
...
tenor = \context Voice = "tenor"   {
	...
	e8 \rest g2 \rest g2 \rest g \rest e4.\rest e8 \rest e4 \rest e8 \rest 
	a8 a a a a a2 ~ a4.
